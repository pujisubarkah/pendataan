  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-14">
    ...
    <div class="bg-blue-50 border-l-4 border-blue-600 text-blue-900 p-4 sm:p-5 rounded-lg mb-8 text-sm md:text-base leading-relaxed text-justify">
      ...
      <p class="mt-4">
        ...
        <a href="mailto:info.sinovik@menpan.go.id" class="font-semibold underline underline-offset-2 hover:text-blue-700">
          info.sinovik@menpan.go.id
        </a>
        atau
        <a href="mailto:inovasiyanlik.menpan@gmail.com" class="font-semibold underline underline-offset-2 hover:text-blue-700">
          inovasiyanlik.menpan@gmail.com
        </a>.
      </p>
    </div>
